...
// Footer is copyright-only by explicit request (reaffirmed: the branding
// <Image> left the bar site-wide too). The Paystack badge and the
// display-currency chip also stayed out — payments messaging lives at
// checkout, the live currency picker lives in the header.
